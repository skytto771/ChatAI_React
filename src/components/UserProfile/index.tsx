...
const UserProfile: React.FC<UserProfileProps> = ({
  ...
  return (
    <div className={styles.userProfileContainer} ref={containerRef}>
      <div
        className={`${styles.userProfile} ${isExpanded ? styles.expanded : ""}`}
        onClick={togglePopup}
      >
      ...
      <div
        className={`${styles.popupMenu} ${isExpanded ? styles.visible : ""}`}
      >
        <button
        ...
        <button
          className={`${styles.popupMenuItem} ${styles.danger}`}
          onClick={onLogout}
        >
