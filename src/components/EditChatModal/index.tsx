...
const editChatModal: React.FC<EditChatModalProps> = ({
  ...
  useEffect(() => {
    ...
    Object.keys(selectChat).forEach((key, index) => {
      ...
      if (formVal.includes(key)) {
        ...
        if (key === "model") {
          onChangeV(
            key as keyof chatSettings,
            Object.values(selectChat)[index] || AVAILABLE_MODELS[0].value,
          );
        }
      }
    });
  ...
  const handleCreate = async () => {
    try {
      const res = await handelEditChatModel({
        conversationId: selectChat.conversationId,
        ...settingsForm,
      });
      toast.success(res);
      onClose();
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formGroup}>
              ...
              <select
                ...
                onChange={(e) => onChangeV("model", e.target.value)}
              >
            ...
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    onChangeV("contextLimit", Number(e.target.value))
                  }
              ...
              <div className={styles.formGroup}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    onChangeV("maxTokens", Number(e.target.value))
                  }
                  className={styles.settingsSelect}
                >
            ...
            {settingsForm.isThinking && (
              <div className={styles.formGroup}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    onChangeV("thinkingMode", e.target.value as any)
                  }
                >
              ...
              {!disableF() && (
                <label className={styles.checkboxLabel}>
                  <input
                    ...
                    onChange={(e) =>
                      onChangeV("thinkingMode", e.target.checked)
                    }
                  />
                  联网搜索
                </label>
              ...
              {!disableF() && (
                <label className={styles.checkboxLabel}>
                  <input
                    ...
                    onChange={(e) =>
                      onChangeV("enableFileUpload", e.target.checked)
                    }
                  />
                  文件上传
                </label>
            ...
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    onChangeV("temperature", Number(e.target.value))
                  }
                />
              </div>
              <div className={styles.formGroup}>
                <label>
                  Top P ({settingsForm.topP == 1 ? "默认" : settingsForm.topP})
                </label>
                <input
                  type="range"
                  min={0}
              ...
              {settingsForm.logprobs && (
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onChangeV("topLogprobs", Number(e.target.value))
                    }
                  />
                </div>
              )}
